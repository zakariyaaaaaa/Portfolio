...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "49135543-d72e-4b5c-8aa3-b6dd2f1babeb");    form.append("name", formData.name);
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">zakariyaboulane1@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">SALAM 01 GR A RUE 16 NR 17 SIDI BERNOUSSI CASA</p>
                  </div>
                </div>
              </div>
            </div>
